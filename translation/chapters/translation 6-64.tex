...
\item[17cd--18ab]
Bile that is accumulated during the rains is aggravated by the heat in autumn. For this reason, when all the clouds have dispersed one should undertake practices that reduce bile. 

\item[18cd--19ab]
During autumn, when one has an appetite, one should eat food that is cool, astringent and sweet, somewhat light and  bitter, as well as mixed with ghee and containing meat of animals from arid regions.\footnote{On the meaning of \emph{jāṅgala} (``the meat of animals from arid regions''), see footnote \ref{jaṅgala}.}
...
\item[19cd--20ab]
While not indulging excessively in sex, one should consume deer, spotted antelopes, quails, goats, black antelopes, and  partridges, along with mung beans, aged rice, and barley.
