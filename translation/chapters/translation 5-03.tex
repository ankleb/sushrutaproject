...
\gls{tārāvitāra}\footnote{“Certain  minerals” translates
    ...
    \emph{et passim}]{wuja-2013b}.}  together with \gls{surendragopa}, and
    a  portion of of \gls{kuruvinda} equal to that,  together with the
    bile called  “brown cow”.\footnote{\dev{surendragopa}  and
        \dev{kuruvinda} are both uncertain; see s.v.\ in the glossary of flora,
        p.\,\pageref{glossary:flora} below. Ḍalhaṇa's opinion has been
        followed here, but it seems fair to say that all commentators were
        guessing.} By the sound of  the musical instrument, even terrible
...
\item
 ...
 and the  \emph{Śatapathabrāhmaṇa},  see  \cite{mana-2019}.  On  “as it is 
 told” for \dev{kila}, see \cite{emen-1969}.\label{kila}}  
...
poisoned arrow and the snakebite.\footnote{\emph{Mādhavanidāna},
    69.20--21 \citep[480]{madhava1} has verses that are directly parallel
    to this section: \dev{darvīkarāṇāṃ viṣam āśughāti sarvāṇi coṣṇe
...
However, flowing in those whose bodies are injured by wasting, in
pregnant women, in those suffering from skin diseases or urinary
disorders, in those who are dehydrated, and in those who are weak,
because of its fineness, sharpness and heat, and also because of its
expansiveness,\footnote{Here, a verse in imperfect upajāti metre is
    added in the margin of \MS{Kathmandu KL 699} but is not fully legible;
    the version of the text at 3.39.2 in \MS{Kathmandu NAK 5-333} is also
    incomplete and not fully comprehensible.}\q{Check this and cf.
        5.3.39.} %  [ślokas in the MSS that aren't in the vulgate. The first
    % line
    %doesn't scan. Witness K adds a part of the start of this in the
    %bottom margin. This material is repeated at 3.39.2 in \MS{Kathmandu
    % NAK
    %5-333}]
    %
    poison that is connected with these qualities permeates a
    wound.\footnote{“Permeates” translates \dev{samanudhāvati}, which
        etymologically means “completely runs after.”} When it is struck by
        wind and heat, it loses its potency. Therefore, not everything that is
        killed by poison and eaten causes death.\footnote{At this point,
            \MS{Kathmandu NAK 5-333} inserts a marginal Indravajrā verse about
...
fatigued and those who stammer, 
 % 3.42: 
