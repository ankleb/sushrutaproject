...
Among these, the person with a wind temperament is wakeful, adverse to
...
On this:
\begin{sloka}
    A person who has a wind temperament is unsteady,  unreliable in friendship, ungrateful, thin and chapped, covered with \sepl{dhamanī}{veins}, 
...
slow to get teeth, wealth or friends.\footnote{This slightly odd
    expression reads like a worldly aphorism; the vulgate reads
...
Someone of a bilious temperament is sweaty, can tolerate the cold, ill-smelling, \se{pīta}{jaundiced} or \se{kāla}{black}.\footnote{This could be a notable reference to yellow and black bile.} His limbs are flaccid, his nails, eyes, palate, tongue, lips, soles and palms have a coppery colour.  He is unlucky, covered in wrinkles and grey hair, he eats a lot, dislikes heat, is habitually quick to anger and quick to calm down, and he has a medium span of life. 
    
\item[69--70]

And on this:
\begin{sloka}
    He is an intelligent, sharp-minded speaker who defeats opponents.\footnote{The terminology \dev{nigṛhyavaktā} refers to the rules of formal debate as described in \CS's Vimānasthāna 8  (see, e.g., \volcite{2}[71]{ober-1991}).}  He is brilliant in conflicts, with unyeilding valiance.
    While he is sleeping he sees 
    \gls{kanaka},
    \gls{palāśa}, and
    \gls{karṇikāra},
    as well as fire, lightning and meteors.
\end{sloka}
\begin{sloka}
    ...
    In this world, his facial expressions and gait always appear distressed. Such a person is one whose temperament is made of bile.\footnote{The vulgate here has a verse, \Su{3.4.71}{361}, identifying bilious types according to the features of various animals, etc. The editors noted that this verse does not appear in manuscripts (\emph{idem}, n.\,2).}
\end{sloka}
 ...
 fresh \gls{ariṣṭaka}, or \gls{śara} stalk.\footnote{Strangely, mostly greenish hues.}  Such a person is  lucky, good-looking, and fond of sweet things.  He is appreciative, steadfast, tolerant, free from desire, strong, slow to acquire, firm in enmity, and long-lived.
