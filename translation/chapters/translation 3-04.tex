...
\begin{sloka}
    Neither the irritatation nor alteration, nor depletion of constitutions
...
\begin{sloka}
    An insect born from poison does not succumb to the poison.  In the same way, the body is not damaged by its constitutions, because it is born from them.
\end{sloka}
